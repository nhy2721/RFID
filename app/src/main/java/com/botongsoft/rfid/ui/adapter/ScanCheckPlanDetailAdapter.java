 ...
 */
public class ScanCheckPlanDetailAdapter extends SwipeMenuAdapter<ScanCheckPlanDetailAdapter.DefaultViewHolder> {
    private Context mContext;
    private static List<Mjjgda> list;

    private OnItemClickListener mOnItemClickListener;

    public ScanCheckPlanDetailAdapter(Context context, List<Mjjgda> list) {
        super();
    ...
    @Override
    public ScanCheckPlanDetailAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ScanCheckPlanDetailAdapter.DefaultViewHolder holder, int position) {
