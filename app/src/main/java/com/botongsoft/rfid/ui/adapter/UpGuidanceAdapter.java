...
public class UpGuidanceAdapter extends SwipeMenuAdapter<UpGuidanceAdapter.DefaultViewHolder> {
    ...
    @Override
    public UpGuidanceAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
    ...
    @Override
    public void onBindViewHolder(UpGuidanceAdapter.DefaultViewHolder holder, int position) {
