 ...
 */
/**
public class DBDiffCallBackDemo extends BaseDiffCallBack<BookInfoResponse> {
    public DBDiffCallBackDemo(List<BookInfoResponse> mOldData, List<BookInfoResponse> mNewData) {
