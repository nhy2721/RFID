 ...
 * 这是一个辅助类，用于管理连接到自定义选项卡服务和
 */

package com.botongsoft.rfid.utils.customtabs;
...
import com.botongsoft.rfid.ui.activity.WebViewActivity;
...
public class CustomTabActivityHelper {
    ...
    public static void openCustomTab(Activity activity,
                                     ...
                                     Uri uri) {
        String packageName =  com.botongsoft.rfid.utils.customtabs.CustomTabsHelper.getPackageNameToUse(activity);
